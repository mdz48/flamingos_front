...
export default function FormEditUsers({ onClose, userData }) {
    const idRef = useRef('');
    ...
    return (
        <div className="p-4 border border-gray-300 rounded shadow-md">
            <form className="flex flex-col">
                ...
                <input type="text" ref={idRef} className="border-2 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" readOnly />
